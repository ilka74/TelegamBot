Многофункциональный телеграм-бот. Данный бот умеет обрабатывать фотографии, делать ASCII-арт и многое другое 
=====================================================================================
...
- resize_for_sticker: изменяет размер изображения для загрузки в Telegram в виде стикера
...
- prepare_sticker_and_send: подготавливает изображение для загрузки в Telegram как стикер и отправляет его
...
(пикселизация, преобразование в ASCII-арт, инверсия, отражение и т.д.)
...
#### Пример преобразования изображения в стикер для загрузки в Telegram  
<img src="images/img_11.PNG" alt="Отражение по вертикали" width="600">

#### Пример запуска случайной шутки из списка (несколько вариантов)  
<img src="images/img_12.PNG" alt="Случайная шутка" width="600">

#### Пример запуска случайного комплимента из списка (несколько вариантов)  
<img src="images/img_13.PNG" alt="Случайный комплимент" width="600">

#### Пример запуска случайного подбрасывания монетки (несколько вариантов)  
<img src="images/img_14.PNG" alt="Подбрасывание монетки" width="600">
