...
(пикселизация, преобразование в ASCII-арт, инверсия, отражение по горизонтали или вертикали и т.д.)
...
#### Пример запуска случайной шутки из списка (три варианта)  
<img src="images/img_12.PNG" alt="Отражение по вертикали" width="600">
